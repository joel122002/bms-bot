...
# Configure logger with rotating file handler to limit log size
logger = logging.getLogger('bms_bot')
logger.setLevel(logging.INFO)
# Rotate when log reaches 5MB, keep 3 backup files
handler = RotatingFileHandler('bms.log', maxBytes=5*1024*1024, backupCount=3)
...
def main():
    ...
    dateCode = "20250913"  # You can modify this dynamically as per requirement
    
    logger.info("Starting BMS Bot")
    while True:
